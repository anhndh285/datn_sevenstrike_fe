      ...
      <div v-for="addr in addresses" :key="addr.id" class="border rounded-3 p-3 mb-3">
        <div class="d-flex justify-content-between align-items-start">
          ...
          <div class="d-flex gap-2">
            ...
            <button class="btn btn-sm btn-outline-secondary" @click="openEditModal(addr)">
              Sửa
            </button>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label small fw-bold">
                Tên địa chỉ <span class="text-danger">*</span>
              </label>
              <input
                type="text"
                class="form-control"
                v-model="addrForm.tenDiaChi"
            ...
            <div class="mb-3">
              ...
              <select
                class="form-select"
                v-model="addrCodes.district"
                @change="onDistrictChange"
                :disabled="!addrCodes.city"
              >
            ...
            <div class="mb-3">
              ...
              <select
                class="form-select"
                v-model="addrCodes.ward"
                @change="onWardChange"
                :disabled="!addrCodes.district"
              >
...
const saveAddress = async () => {
  ...
  try {
    ...
    modalError.value = getErrorMessage(err, 'Lưu thất bại!');
  } finally {
...
const setDefault = async (id) => {
  ...
  try {
    ...
    alert(getErrorMessage(err, 'Đặt mặc định thất bại!'));
  }
};
