  ...
  <div class="ss-page ss-font">
    ...
    <div class="ss-head">
      ...
      <div class="ss-head-right">
        <div class="ss-count">
          Tổng số form chân: <span>{{ totalCount }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="ss-card ss-border ss-filter-card">
      ...
      <div class="ss-filter-body">
        <div class="ss-filter-left">
          <div class="ss-filter-label">Tìm kiếm form chân</div>
        ...
        <table class="table ss-table mb-0">
          <thead>
            <tr>
              ...
              <th class="col-ten">Tên form chân</th>
...
async function fetchAll() {
  ...
  try {
    const res =
      typeof formChanService.getAll === "function"
        ? await formChanService.getAll()
        : await formChanService.all?.();
...
function exportExcel() {
  ...
  a.href = url;
  a.download = `form_chan_${new Date().toISOString().slice(0, 10)}.csv`;
